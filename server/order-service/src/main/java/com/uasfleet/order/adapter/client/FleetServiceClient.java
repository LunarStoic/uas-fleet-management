 ...
 *   - Declarative: Define the API contract as an interface, not imperative code
 *   - Integrated: Automatic Eureka discovery and client-side load balancing
 *   - Testable: Easy to mock in unit tests (just mock the interface)
 *   - Type-safe: Compile-time checks on method signatures
 * =============================================================================
 */
@FeignClient(
    name = "fleet-service",                        // Logical name in Eureka registry
